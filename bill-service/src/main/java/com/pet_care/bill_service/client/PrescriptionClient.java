...
public interface PrescriptionClient {
    ...
    @PostMapping("${service.medical-prescription-client.path}/prescription/{prescriptionId}/approved")
    void approvedPrescription(@PathVariable("prescriptionId") Long prescriptionId);
}
